...
const DEFAULT_CTA = {
  ...
  mainTitleHighlight: 'Project Management?',
  description:
    'Join thousands of teams who have streamlined their workflow with our powerful project management platform. Start your 14-day free trial and experience the difference.',
  primaryCTA: 'Start Free Trial',
  primaryCTAHref: '/signup',
  secondaryCTA: 'Watch Demo',
  secondaryCTAHref: '/demo',
  trustText: 'Trusted by leading teams worldwide',
  stat1Value: '25K+',
  stat1Label: 'Active Teams',
  stat2Value: '99.9%',
  stat2Label: 'Uptime',
  stat3Value: '1M+',
  stat3Label: 'Tasks Completed',
  stat4Value: '24/7',
  stat4Label: 'Support',
  ...
  feature2Description: 'Bank-level encryption and SOC 2 compliance',
  feature3Title: 'Quick Setup',
  feature3Description: 'Import your data and get started in under 5 minutes',
} as const;
