...
const DEFAULT_FOOTER = {
  logoText: 'TaskFlow',
  companyDescription:
    'Streamline your project management with powerful tools designed for modern teams. Join thousands of organizations who trust TaskFlow to deliver projects on time and within budget.',
  contactEmail: 'hello@taskflow.com',
  contactPhone: '+1 (555) 847-2563',
  contactAddress: '456 Innovation Drive, Suite 200',
  newsletterTitle: 'Stay in the Loop',
  newsletterPlaceholder: 'Enter your email address',
  newsletterDisclaimer: 'Get product updates, tips, and exclusive offers. Unsubscribe anytime.',
  section1Title: 'Product',
  section2Title: 'Company',
  section3Title: 'Resources',
  section4Title: 'Legal',
  copyrightText: '© 2024 TaskFlow. All rights reserved.',
  madeWithText: 'with ❤️ by the TaskFlow team',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/taskflow',
  social2Href: 'https://facebook.com/taskflow',
  social3Href: 'https://instagram.com/taskflow',
  social4Href: 'https://linkedin.com/company/taskflow',
  social5Href: 'https://github.com/taskflow',
  // Product Links
  linkFeatures: 'Features',
  linkFeaturesHref: '#features',
  linkPricing: 'Pricing',
  linkPricingHref: '#pricing',
  linkTemplates: 'Project Templates',
  ...
  linkCookieSettings: 'Cookie Preferences',
