...
const DEFAULT_PRICING = {
  ...
  mainTitleHighlight: 'Perfect Plan',
  mainDescription:
    'Scale your project management with flexible pricing designed for teams of all sizes. Start free and upgrade as you grow.',
  ...
  plans: [
    ...
    },
    {
      ...
      cta: 'Contact Sales',
      ctaHref: '/contact',
      trial: 'Custom onboarding & training included',
      popular: false,
      features: [
        'Everything in Pro',
  ...
  bottomDescription:
    'We work with enterprise teams to create tailored project management solutions that fit your unique workflow and requirements.',
