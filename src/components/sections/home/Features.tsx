...
const DEFAULT_FEATURES = {
  ...
  mainTitle: 'Everything You Need to Manage Projects',
  mainTitleHighlight: 'Built for High-Performance Teams',
  mainDescription:
    'Streamline your project workflows with our comprehensive project management platform designed for modern teams and agile organizations.',
  feature1Title: 'Real-Time Collaboration',
  feature1Description:
    'Work together seamlessly with live updates, instant messaging, and collaborative workspaces that keep everyone in sync.',
  feature1Badge: 'Collaboration',
  feature2Title: 'Advanced Security & Permissions',
  feature2Description:
    'Enterprise-grade security with role-based access controls, SSO integration, and complete audit trails for compliance.',
  feature2Badge: 'Security',
  feature3Title: 'Mobile Project Management',
  feature3Description:
    'Stay productive on the go with native mobile apps for task management, time tracking, and team communication.',
  feature3Badge: 'Mobile',
  feature4Title: 'Multi-Project Dashboard',
  feature4Description:
    'Manage multiple projects, track progress across teams, and get insights from a unified command center.',
  feature4Badge: 'Dashboard',
  feature5Title: 'Advanced Analytics & Reports',
  feature5Description:
    'Track team productivity, project velocity, and resource utilization with 40+ customizable reports and KPIs.',
  feature5Badge: 'Analytics',
  feature6Title: 'Automated Workflows',
  feature6Description:
    'Create custom automation rules, approval processes, and smart notifications to eliminate repetitive tasks.',
  feature6Badge: 'Automation',
  feature7Title: 'Integrations & API',
  feature7Description:
    'Connect with 100+ tools including Slack, GitHub, Jira, and custom integrations via our robust REST API.',
  feature7Badge: 'Integration',
  feature8Title: '24/7 Expert Support',
  feature8Description:
    'Get help when you need it with dedicated customer success managers and 99.9% uptime guarantee.',
  feature8Badge: 'Support',
  feature9Title: 'Data Security & Backup',
  feature9Description:
    'Your project data is encrypted, automatically backed up, and stored securely with enterprise-grade protection.',
  feature9Badge: 'Privacy',
  ctaQuestion: 'Ready to transform your project management?',
